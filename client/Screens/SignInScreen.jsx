	...
	return (
		<View style={LoginStyles.container}>
			<View style={{ ...LoginStyles.main, ...LoginStyles.sign_in }}>
				<View style={[LoginStyles.card, LoginStyles.shadowProp]}>
					<Image source={user_logo} style={LoginStyles.logo}></Image>
					<View style={LoginStyles.card_head}>
						<Text style={LoginStyles.header}></Text>
					</View>
					<View style={LoginStyles.card_body}>
						<View style={LoginStyles.form_group}>
							<Text style={LoginStyles.form_label}>Email</Text>
							<TextInput
						...
						<View style={LoginStyles.form_group}>
							<Text style={LoginStyles.form_label}>Password</Text>
							<TextInput
								style={LoginStyles.form_control}
								secureTextEntry
								value={password}
